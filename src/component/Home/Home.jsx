...
export default function Home() {
    ...
    // ✅ Testimonials (updated names you gave)
    const homeclient = [
        {
            name: "Harish",
            star: "⭐️⭐️⭐️⭐️⭐️",
            description: "The digital marketing campaign exceeded all our expectations. Our social media engagement increased by 250% and lead generation improved by 180%.",
        ...
        },
        {
            name: "Venkat",
            star: "⭐️⭐️⭐️⭐️⭐️",
            description: "Our custom mobile application was delivered on time and exceeded all requirements. The user experience is exceptional, and our app ratings improved significantly.",
        ...
        },
        {
            name: "Sharan",
            star: "⭐️⭐️⭐️⭐️⭐️",
            description: "The branding package was absolutely perfect. Our new logo and brand identity received countless compliments. The team understood our vision perfectly.",
        ...
        },
        {
            name: "Gokul Vijay",
            star: "⭐️⭐️⭐️⭐️⭐️",
            description: "Skill Honour delivered a modern e-commerce solution that boosted our sales and provided smooth customer experience. Truly professional service.",
    ...
    const portData = [
        {
            ...
            description: "Modern e-commerce website with shopping cart and admin dashboard.",
    ...
    return (
        <div className="homepage">
            ...
            {/* ✅ SEO Meta Tags */}
            <Helmet>
                <title>Skill Honour | Web Development, Digital Marketing & Custom Software Solutions</title>
                <meta
                    name="description"
                    content="Skill Honour specializes in web development, digital marketing, and custom application development. We help businesses grow with SEO, responsive websites, e-commerce, branding, and mobile apps."
                />
                <meta
                    name="keywords"
                    content="web development company, digital marketing agency, custom application development, SEO services, e-commerce website, branding and design, mobile app development, Skill Honour"
                />
            </Helmet>
            ...
            <div className="firsthome">
                ...
                <div className="firstpara">
                    <p>We deliver exceptional technology solutions with skill, honour, and innovation. From web development to cloud hosting, we're your trusted partner for digital transformation.</p>
                </div>
            ...
            <div className="secondhome">
                ...
                <div className="secondbox-content">
                    <div className="secondboxhome secondbox1">
                        <img src={web} alt="Web Development Service" />
                    ...
                    <div className="secondboxhome secondbox2">
                        <img src={market} alt="Digital Marketing Service" />
                    ...
                    <div className="secondboxhome secondbox3">
                        <img src={custom} alt="Custom Application Development" />
            ...
            <div className="thirdhome">
                ...
                <div className="thirdbox-content">
                    {portData.map((portdata, index) => (
                        <div className="thirdbox" key={index}>
                            <img src={portdata.img} alt={portdata.projname} />
                ...
                <button onClick={moveport}>View All Projects</button>
            </div>
            ...
            <div className="fourhome">
                ...
                <div className="fourbox-content">
                    {homeclient.map((homeclientval, index) => (
                        <div className="fourbox" key={index}> 
                            <div className="fourhandling">
                                <div className="lefthandling">
                                    <img src={homeclientval.image} alt={homeclientval.name} />
                                </div>
            ...
            <div className="fivehome">
                <h1>Why Choose <span>Skill Honour?</span></h1>
