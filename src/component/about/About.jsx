...
const About = () => {
    ...
    return (
        <>
            {/* SEO Meta Tags */}
            <Helmet>
                <title>About Us | Skill Honour - Web Development, Marketing & Design</title>
                <meta
                    name="description"
                    content="Learn about Skill Honour - a team of experts in web development, digital marketing, graphic design, and WordPress development. Our mission is to deliver innovation, excellence, and growth for businesses."
                />
                <meta
                    name="keywords"
                    content="Skill Honour, web development, digital marketing, SEO, graphic design, WordPress development, IT solutions, business growth, software company"
                />
            </Helmet>
            ...
            <div className="about-container">
                ...
                <div className="askill-honor">
                    <h1 className="skill-name">About <span className='color-skill'>Skill Honour</span></h1>
                    <p className="skill-para1">Learn about our mission, values, and the talented team behind our</p>
                    <p className="skill-para2">innovative technology solutions.</p>
                </div>

                {/* ======== Our Story =========== */}
                <div className="our-story">
                    <h1 className="story-name">Our <span className="color-skilled">Story</span></h1>
                    <p className="story-para1">Founded in 2019, Skill Honour began as a vision to bridge the gap between cutting-edge technology and</p>
                    ...
                    <p className="story-para4">Today, we're a team of passionate professionals dedicated to delivering exceptional results through skill, honour,</p>
                ...
                <div className="our-team">
                    ...
                    <p className="team-para1">The talented professionals behind Skill Honour's success, each bringing unique expertise</p>
